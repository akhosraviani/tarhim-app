...
class LoginRepository {
    ...
    val mldShareLink = MutableLiveData<ConfirmDataModel>()
    ...
    val mldContact = MutableLiveData<List<ContactModel>>()
    ...
    fun getContactsData(context: Context) {
        val arrayList_Android_Contacts: ArrayList<ContactModel> = ArrayList<ContactModel>()
        ...
        try {
            ...
            Log.e("Error on contact", ex.message!!)
        }
...
//< init >
                var android_contact: ContactModel? = null
                var contact_id = cursor_Android_Contacts!!.getString(
                    cursor_Android_Contacts.getColumnIndex(
                        ContactsContract.Contacts._ID
                    )
                );
                var contact_display_name = cursor_Android_Contacts!!.getString(
                    cursor_Android_Contacts.getColumnIndex(
...
//</ init >
                ...
                val hasPhoneNumber = cursor_Android_Contacts!!.getString(
                    cursor_Android_Contacts!!.getColumnIndex(ContactsContract.Contacts.HAS_PHONE_NUMBER)
                ).toInt()
                if (hasPhoneNumber > 0) {
                    ...
                    while (phoneCursor!!.moveToNext()) {
                        ...
                        //< set >
                        android_contact!!.phone = phoneNumber
                        //</ set >
                    }
                    phoneCursor!!.close()
                }
                ...
                mldContact.value = arrayList_Android_Contacts
            }
    ...
    fun ShareLink(id: Int, mobile: String) {
        RequestClient.makeRequest().ShareLink(id, mobile)
            .enqueue(object : Callback<ConfirmDataModel> {
                override fun onResponse(
                    call: Call<ConfirmDataModel>,
                    response: Response<ConfirmDataModel>
                ) {
                    mldShareLink.value = ConfirmDataModel(
    ...
    fun requestFollowing(mobile: String) {
        RequestClient.makeRequest().requestFollowingList(mobile)
            .enqueue(object : Callback<List<MyDeceasedDataModel>> {
                override fun onFailure(
                    call: Call<List<MyDeceasedDataModel>>,
                    t: Throwable
                ) {
                    Log.e(TAG, "onFailure: " + t.message)
                    mldError.value = t
    ...
    fun requestDeceasedFollowersList(deceasedId: Int) {
        RequestClient.makeRequest().requesDeceasedFollowersList(deceasedId)
            .enqueue(object : Callback<List<FollowersDataModel>> {
                override fun onFailure(
                    call: Call<List<FollowersDataModel>>,
                    t: Throwable
                ) {
                    Log.e(TAG, "onFailure: " + t.message)
                    mldError.value = t
    ...
    fun requestGetSiritualRes(id: Int, mobile: String) {
        RequestClient.makeRequest().requestGetSiritualDeceased(id, mobile)
            .enqueue(object : Callback<List<PrayDeceasedDataModel>> {
                override fun onFailure(
                    call: Call<List<PrayDeceasedDataModel>>,
                    t: Throwable
                ) {
                    Log.e(TAG, "onFailure: " + t.message)
                    mldError.value = t
    ...
    fun requestGetPray() {
        RequestClient.makeRequest().requestPray()
            .enqueue(object : Callback<List<RequirementDataModel>> {
                override fun onFailure(
                    call: Call<List<RequirementDataModel>>,
                    t: Throwable
                ) {
                    Log.e(TAG, "onFailure: " + t.message)
                    mldError.value = t
    ...
    fun requestGetCharity() {
        RequestClient.makeRequest().requestGetCharity()
            .enqueue(object : Callback<List<CharityDataModel>> {
                override fun onFailure(
                    call: Call<List<CharityDataModel>>,
                    t: Throwable
                ) {
                    Log.e(TAG, "onFailure: " + t.message)
                    mldError.value = t
    ...
    fun requestMyInbox(mobile: String) {
        RequestClient.makeRequest().requestMyInbox(mobile)
            .enqueue(object : Callback<List<MyInboxDataModel>> {
                override fun onFailure(
                    call: Call<List<MyInboxDataModel>>,
                    t: Throwable
                ) {
                    Log.e(TAG, "onFailure: " + t.message)
                    mldError.value = t
    ...
    fun requestMyContactsList(id: Int) {
        RequestClient.makeRequest().requestMyListOfPhone(id)
            .enqueue(object : Callback<List<ListOfContactsModel>> {
                override fun onFailure(
                    call: Call<List<ListOfContactsModel>>,
                    t: Throwable
                ) {
                    Log.e(TAG, "onFailure: " + t.message)
                    mldError.value = t
    ...
    fun requestGetGallery(id: Int) {
        RequestClient.makeRequest().requestGetGallery(id)
            .enqueue(object : Callback<List<GalleryDataModel>> {
                override fun onFailure(
                    call: Call<List<GalleryDataModel>>,
                    t: Throwable
                ) {
    ...
    fun requestLatestSearch(mobile: String) {
        RequestClient.makeRequest().requestLatestSearch(mobile)
            .enqueue(object : Callback<List<DeceasedDataModel>> {
                override fun onFailure(
                    call: Call<List<DeceasedDataModel>>,
                    t: Throwable
                ) {
                    mldError.value = t
                    Log.e(TAG, "onFailure: " + t.message)
    ...
    fun requestMapMatching(path: List<LatLng>) {
        MapRequest.makeRequest().requestMap(path)
            .enqueue(object : Callback<MapMatching> {
                override fun onFailure(call: Call<MapMatching>, t: Throwable) {
                    Log.e(TAG, "onFailure: " + t.message)
                    mldError.value = t
                ...
                override fun onResponse(
                    ...
                    Log.i(
                        "testTag44",
                        "im here in map= " + response.body()!!.snappedPoints.toString()
                    )
                }
            })
